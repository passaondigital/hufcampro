...
function TGuide({ lineColor }: { lineColor: string }) {
  return (
    <g>
      <line x1="0" y1="75" x2="100" y2="75" stroke={lineColor} strokeWidth="0.5" strokeLinecap="round" />
      ...
      <line x1="50" y1="10" x2="50" y2="75" stroke={lineColor} strokeWidth="0.5" strokeLinecap="round" />
      <polygon points="50,8 48,12 52,12" fill={lineColor} />
    </g>
  );
}
...
function LGuide({ lineColor }: { lineColor: string }) {
  return (
    <g>
      <line x1="0" y1="85" x2="100" y2="85" stroke={lineColor} strokeWidth="0.5" strokeLinecap="round" />
      ...
      <line x1="85" y1="10" x2="85" y2="85" stroke={lineColor} strokeWidth="0.5" strokeLinecap="round" />
      <rect x="83" y="83" width="4" height="4" fill="none" stroke={lineColor} strokeWidth="0.3" />
    </g>
  );
}
...
function TargetGuide({ lineColor }: { lineColor: string }) {
  return (
    <g>
      <line x1="35" y1="50" x2="65" y2="50" stroke={lineColor} strokeWidth="0.4" strokeLinecap="round" />
      <line x1="50" y1="35" x2="50" y2="65" stroke={lineColor} strokeWidth="0.4" strokeLinecap="round" />
      <circle cx="50" cy="50" r="1.5" fill={lineColor} />
      <circle cx="50" cy="50" r="20" fill="none" stroke={lineColor} strokeWidth="0.4" strokeDasharray="3,2" />
      <circle cx="50" cy="50" r="30" fill="none" stroke={lineColor} strokeWidth="0.2" strokeDasharray="1,3" opacity="0.5" />
    </g>
  );
}
